...
export const BROWSER_BASIC_COMMAND_SPECS: CommandSpec[] = [
  ...
  },
  {
    ...
    usage:
      'korca wait [--selector <sel>] [--timeout <ms>] [--text <text>] [--url <pattern>] [--load <state>] [--fn <js>] [--state <hidden|visible>] [--worktree <selector>] [--json]',
    allowedFlags: [
      ...GLOBAL_FLAGS,
      'selector',
      'timeout',
  ...
  },
  {
    ...
    usage: 'korca tab profile list [--json]',
    allowedFlags: [...GLOBAL_FLAGS]
  },
  {
    path: ['tab', 'profile', 'create'],
    summary: 'Create a browser session profile for browser tabs',
    usage: 'korca tab profile create --label <name> [--scope <isolated|imported>] [--json]',
