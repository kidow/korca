export const TOGGLE_TERMINAL_PANE_EXPAND_EVENT = 'korca-toggle-terminal-pane-expand'
export const FOCUS_TERMINAL_PANE_EVENT = 'korca-focus-terminal-pane'
export const PASTE_TERMINAL_TEXT_EVENT = 'korca-paste-terminal-text'
export const SPLIT_TERMINAL_PANE_EVENT = 'korca-split-terminal-pane'
export const CLOSE_TERMINAL_PANE_EVENT = 'korca-close-terminal-pane'
export const BACKGROUND_MOUNT_TERMINAL_WORKTREE_EVENT = 'korca-background-mount-terminal-worktree'
...
export const SYNC_FIT_PANES_EVENT = 'korca-sync-fit-panes'
