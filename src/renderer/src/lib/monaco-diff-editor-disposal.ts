...
type GuardedDiffEditor = editor.IStandaloneDiffEditor & {
  __korcaDiffEditorDisposeGuardInstalled?: true
}

type GuardedEditorNamespace = MonacoDiffEditorNamespace['editor'] & {
  __korcaDiffEditorFactoryGuardInstalled?: true
}
...
export function guardMonacoDiffEditorDispose(
  ...
  if (guardedDiffEditor.__korcaDiffEditorDisposeGuardInstalled) {
    return diffEditor
  }
  ...
  guardedDiffEditor.__korcaDiffEditorDisposeGuardInstalled = true
...
export function installMonacoDiffEditorDisposalGuard(
  ...
  if (editorNamespace.__korcaDiffEditorFactoryGuardInstalled) {
    return
  }
  ...
  editorNamespace.__korcaDiffEditorFactoryGuardInstalled = true
}
