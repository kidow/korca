export const ORCHESTRATION_SETUP_STATE_EVENT = 'korca:orchestration-setup-state'
export const ORCHESTRATION_ENABLED_STORAGE_KEY = 'korca.orchestration.enabled'
export const ORCHESTRATION_SETUP_DISMISSED_STORAGE_KEY = 'korca.orchestration.setupDismissed'
