...
const markdownPreviewSanitizeSchema = {
  ...
  protocols: {
    ...
    // user-selected path before opening it in Korca. Sanitization must preserve
  ...
  attributes: {
    ...
    details: [
      ...
      'open',
      ['className', 'korca-details'],
      ['dataKorcaToggle', 'heading-1']
    ],
        ...
        const handleClick = async (event: React.MouseEvent<HTMLAnchorElement>): Promise<void> => {
          ...
          if (!targetWorktree) {
            if (sourceRoutingWorktreeId && worktreeRoot) {
              ...
              // so there may be no repo worktree even though Korca can stat/open
...
function MarkdownSingleNoteSendMenu({
  ...
  return (
    <NotesSendMenu
      ...
      triggerClassName="korca-diff-comment-pill-btn"
