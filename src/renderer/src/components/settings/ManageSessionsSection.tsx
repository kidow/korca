...
// keeps the Manage Sessions table visually consistent with how Korca labels
// the same worktrees in the bottom status bar ("korca/Anemone").
...
function formatWorkspace(session: { cwd: string | null; sessionId: string }): string {
  ...
  // revived sessions, older protocol versions). Korca's session IDs embed
