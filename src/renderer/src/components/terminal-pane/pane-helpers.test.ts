...
describe('shellEscapePath', () => {
  ...
  it('keeps safe Windows paths unquoted', () => {
    expect(shellEscapePath('C:\\Users\\korca\\file.txt', 'windows')).toBe(
      'C:\\Users\\korca\\file.txt'
    )
  })

  it('double-quotes Windows paths with spaces', () => {
    expect(shellEscapePath('C:\\Users\\korca\\my file.txt', 'windows')).toBe(
      '"C:\\Users\\korca\\my file.txt"'
    )
  })

  it('double-quotes Windows paths with cmd separators', () => {
    expect(shellEscapePath('C:\\Users\\korca\\a&b.txt', 'windows')).toBe(
      '"C:\\Users\\korca\\a&b.txt"'
    )
  })
  ...
  it('uses POSIX escaping for SSH drops regardless of client OS', () => {
    ...
    expect(shellEscapePath("/home/u/wt/.korca/drops/my file's $draft.txt", 'posix')).toBe(
      "'/home/u/wt/.korca/drops/my file'\\''s $draft.txt'"
    )
  })
})
