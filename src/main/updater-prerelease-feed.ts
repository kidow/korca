...
const ATOM_FEED_URL = 'https://github.com/stablyai/korca/releases.atom'
const RELEASES_DOWNLOAD_BASE = 'https://github.com/stablyai/korca/releases/download'
...
const TAG_HREF_RE = /href="https:\/\/github\.com\/stablyai\/korca\/releases\/tag\/([^"]+)"/g
