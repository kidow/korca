...
describe('AmpHookService', () => {
  ...
  beforeEach(() => {
    homeDir = mkdtempSync(join(tmpdir(), 'korca-amp-home-'))
  ...
  it('installs an Korca-managed Amp system plugin', () => {
    ...
    expect(source).toContain('process.env.KORCA_PANE_KEY')
  ...
  it('removes only Korca-managed Amp plugin files', () => {
