  ...
  it.each([
    ...
    async (platform, manifestName) => {
      ...
      expect(manifestUrls).toEqual([
        `https://github.com/stablyai/korca/releases/download/v1.4.1/${manifestName}`
      ])
      expect(assetUrls).toEqual([
        'https://github.com/stablyai/korca/releases/download/v1.4.1/Korca-1.4.1-arm64-mac.zip'
      ])
    }
  )
