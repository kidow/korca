...
// target_type narrows to the four shapes Korca renders meaningfully —
...
// tab so users can see which job failed and where without leaving Korca.
...
export type GitLabWorkItemDetails = {
   ...
   *  picker) — main-process doesn't know Korca's Repo.id. */
