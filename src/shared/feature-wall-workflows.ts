...
export const FEATURE_WALL_WORKFLOWS: readonly FeatureWallWorkflow[] = [
  {
    ...
    lede: 'Korca splits each task into an isolated workspace so agents can run in parallel.',
  ...
  },
  {
    ...
    title: 'Agents',
    meta: 'Agents · Usage · Korca CLI',
    lede: 'Run several agents at once, track their progress, and let automation drive Korca when it helps.',
  ...
  },
  {
    ...
    lede: 'Bring your terminal setup into Korca, then split panes to keep servers, tests, logs, and agents running side by side.',
