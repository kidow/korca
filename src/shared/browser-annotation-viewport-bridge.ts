...
export const BROWSER_ANNOTATION_VIEWPORT_MESSAGE_PREFIX = '__korca_annotation_viewport__:'
...
export function buildBrowserAnnotationViewportBridgeScript({
  ...
  const stateKey = '__korcaBrowserAnnotationViewportBridge';
  const hostAttribute = 'data-korca-browser-annotation-overlay';
  const markerSize = 24;
