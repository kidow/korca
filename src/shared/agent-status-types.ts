...
// These types define the normalized status that Korca receives from Claude,
...
export type AgentStateHistoryEntry = {
   ...
   *  (for example Claude Code `is_interrupt`) or Korca's guarded interrupt
...
export type AgentStatusEntry = {
   ...
   *  inferred by Korca's guarded interrupt fallback.
