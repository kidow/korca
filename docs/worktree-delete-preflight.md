...
- `removeManagedWorktree` runtime/RPC (`src/main/runtime/korca-runtime.ts`)
...
3. Wire runtime ordering and failure mapping in `src/main/runtime/korca-runtime.ts`; update `src/main/runtime/korca-runtime.test.ts`.
