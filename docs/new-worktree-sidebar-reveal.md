...
Issue https://github.com/stablyai/korca-internal/issues/350 asks that newly created worktrees jump into view in the left sidebar list with no scroll animation.
