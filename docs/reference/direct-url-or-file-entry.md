...
1. A URL to open an Korca browser tab.
...
- Do not open external URLs outside Korca.
...
- No active worktree: disable the entry, including URL entry, because Korca browser tabs are worktree-scoped.
