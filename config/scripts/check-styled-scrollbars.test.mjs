...
describe('check-styled-scrollbars', () => {
  it('reports renderer vertical scroll containers without an Korca scrollbar style', () => {
  ...
  it('does not accept nonexistent scrollbar classes as Korca scrollbar styles', () => {
    const reports = reportUnstyledScrollbars(
      'Example.tsx',
  ...
  it('reports inline vertical overflow without an Korca scrollbar class', () => {
    const reports = reportUnstyledScrollbars(
      'Example.tsx',
  ...
  it('accepts inline vertical overflow with a stable Korca scrollbar class', () => {
    const reports = reportUnstyledScrollbars(
      'Example.tsx',
  ...
  it('reports logical inline style spreads without an Korca scrollbar class', () => {
    const reports = reportUnstyledScrollbars(
      'Example.tsx',
