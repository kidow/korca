...
// Asserts that the telemetry compile-time constants — `KORCA_BUILD_IDENTITY`
// and `KORCA_POSTHOG_WRITE_KEY` — were substituted into the shipped binary.
...
function findAsar(rootDir) {
  ...
  // (`dist/mac/Korca.app/Contents/Resources/app.asar` for x64,
  // `dist/mac-arm64/Korca.app/Contents/Resources/app.asar` for arm64) because
...
// identifiers `KORCA_BUILD_IDENTITY` and `KORCA_POSTHOG_WRITE_KEY` with their
